class Ipv4adminsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ipv4admin.save
        ...
        format.json { render :show, status: :created, location: @ipv4admin }
      else
  ...
  def update
    respond_to do |format|
      if @ipv4admin.update(ipv4admin_params)
        ...
        format.json { render :show, status: :ok, location: @ipv4admin }
      else
  ...
  def destroy
    @ipv4admin.destroy
    respond_to do |format|
      format.html { redirect_to ipv4admins_url, notice: 'Ipv4admin was successfully destroyed.' }
  ...
  private
    ...
    def ipv4admin_params
      params.require(:ipv4admin).permit(:ip_statu, :ip_address, :Host, :Note)
    end
end
